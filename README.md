...
```javascript
import isBooleanDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-boolean-data-type@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-assert-is-boolean-data-type/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/ndarray-base-assert-is-boolean-data-type/actions/workflows/test.yml?query=branch:v0.2.1
